...
The distribution is heavily skewed right, with a minimum of 0.001 acres and a maximum of 4.65 acres. The mean acreage is 0.236.
...
The majority of the residences in the scatterplot are clustered with low acreage and low to medium price. There is no clear correlation due to the extreme density of points. However, we can tell that it is a positive correlation between acreage and sale price.
